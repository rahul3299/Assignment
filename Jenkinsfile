    ...
    stage('Pull image from EC2')
    {
      ...
      { script
       
       {
         ...
         bat """ssh -i rahul.pem -t -o StrictHostKeyChecking=no ec2-user@18.222.169.223 "sudo docker rm --force my-assignment; sudo docker run -d --name aws-docker -p 9098:8080 rahul3299/my-assignment:${BUILD_NUMBER}" """
      }
      }
    }
